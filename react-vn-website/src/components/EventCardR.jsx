// EventCardR.jsx (identical except for gradient color)
import React, { useState } from 'react';
import { ChevronLeft, ChevronRight } from 'lucide-react';

const EventCardR = ({ name, description, date, reportUrl, images }) => {
  ...
  return (
    <div className="w-full bg-gradient-to-t from-red-400/40 to-grey-100 hover:bg-gradient-to-t hover:from-grey-100 hover:to-red-400/20 transition-all duration-300 rounded-lg shadow-lg p-4 mb-6 ">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-3">
      <h3 className="text-xl font-title font-bold mt-2 pl-2 mb-3">{name}</h3>
      {date && (
